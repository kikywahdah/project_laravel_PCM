    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h2 class="mb-1 fw-bold text-success">Tambah Usaha Baru</h2>
                    <p class="text-muted mb-0">Tambah data usaha PCM Benowo</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-0 py-3">
            <h5 class="mb-0 fw-bold text-success">
                <i class="fas fa-edit me-2"></i>Form Tambah Usaha
            </h5>
        </div>
            ...
            <form action="{{ route('usaha.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="jenis_usaha" class="form-select @error('jenis_usaha') is-invalid @enderror" required>
                            ...
                            <option value="Perusahaan" {{ old('jenis_usaha') == 'Perusahaan' ? 'selected' : '' }}>Perusahaan</option>
                            <option value="Toko" {{ old('jenis_usaha') == 'Toko' ? 'selected' : '' }}>Toko</option>
                            <option value="Warung" {{ old('jenis_usaha') == 'Warung' ? 'selected' : '' }}>Warung</option>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" 
                                  rows="4" placeholder="Tambahkan keterangan usaha (opsional)">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save me-2"></i>Simpan Usaha
                    </button>
                </div>
            </form>
        </div>
